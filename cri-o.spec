...
Version  : 1.11.2
Release  : 24
URL      : https://github.com/kubernetes-incubator/cri-o/archive/v1.11.2.tar.gz
Source0  : https://github.com/kubernetes-incubator/cri-o/archive/v1.11.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535582663
make  %{?_smp_mflags}
